...
MVN_VERSIONS_DIRECTORY="/Applications/Maven"
...
function debugMaven()
{
	MAVEN_OPTS="$MAVEN_OPTS -Xdebug -Xnoagent -Djava.compiler=NONE -Xrunjdwp:transport=dt_socket,server=y,suspend=y,address=5005" mvn $@
}
